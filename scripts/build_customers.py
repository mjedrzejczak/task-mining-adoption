import sys, zipfile, re, json, datetime as dt
...
# Datadog May 2026 active clients per team domain (from src/data/adoption.ts)
team_clients = {
    "allianz-global": 648, "refinitiv": 577, "prod": 469, "majid-ai-futtaim": 231,
    "nykredit-realkredit": 226, "nec-corporation-2": 151, "anglo-american": 146,
    "allstate": 137, "kapitus": 137, "production": 128, "astrazeneca-dev": 71,
    "mol": 62, "dbank": 48, "dai-ichi-life-insurance": 40, "aflac": 38,
    "ofi-benelux-b-v--om-kaemingk-c4c": 35, "schlumberger": 31, "kimberlyclark": 31,
    "fujitsu-limited-product-business-task-mining-c4c": 20, "riverty": 20,
    "schlumberger-qa": 15, "kistler-prod": 12, "kn-sb": 12, "endpoint": 11,
    "amgen": 9, "siemens-sandbox": 8, "pepsico-prod": 8, "ibm-crossmark-c4c": 8,
    "upm-sandbox": 7, "caceis-task-mining-pov": 7, "banco-pichincha": 7, "kn": 7,
    "dpdhl": 6, "telefonica-productive": 6, "productive": 5, "dbank-psb": 5,
    "merck-tst": 4, "envalior": 4, "eight-japan-engineering-consultants": 3,
    "rabobank": 2, "booking-holdings": 2, "syngenta-prod": 2, "diot-siaci": 2,
    "michelin": 2, "gs-training-2026": 2, "mondelez": 1, "nationwide-prod": 1,
    "panasonic-information": 1, "rabobank-sb": 1,
}
...
ts.append("// with current adoption (active clients) from the Datadog May 2026 snapshot.")
...
ts.append("  activeClients: number; // distinct active clients, Datadog May 2026")
